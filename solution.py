# Disappearing text program python
# tkinter delete text from textbox
# https://github.com/njiang6/disappearing-text-app/blob/main/disappearing_text_writing_app.py
